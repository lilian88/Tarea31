...
public class MainActivityLVPA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity_lvp);
    ...
    public void InsetarBtn (View v) {
        ...
        if (Insertadatos) {
            Toast.makeText(MainActivityLVPA.this, "Datos Ingresados", Toast.LENGTH_SHORT).show();
        }else{Toast.makeText(MainActivityLVPA.this,"Datos no Ingresados ocurrio un error",Toast.LENGTH_SHORT).show();}
    }
    ...
    public void Modificar (View v) {
        ...
        if(ActualizandoDatos)
            ...
            Toast.makeText(MainActivityLVPA.this,"Lo sentimos ocurrió un error",Toast.LENGTH_SHORT).show();
    ...
    public void Eliminar (View v) {
        ...
        if(registrosEliminados > 0 ){
            Toast.makeText(MainActivityLVPA.this,"Registro(s) Eliminado(s)",Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(MainActivityLVPA.this,"ERROR: Registro no eliminado",Toast.LENGTH_SHORT).show();
        }
    }
}
